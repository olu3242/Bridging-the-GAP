...
export const NAV_ITEMS: readonly NavItem[] = [
  ...
  },
  {
    ...
    label: "AI tutor",
    icon: Bot,
    capability: "learner.dashboard.view",
  },
  {
    href: "/projects",
    label: "Projects",
    icon: Hammer,
    capability: "project.manage_own",
  },
  {
    href: "/contributions",
    label: "Data Corps",
  ...
  },
  {
    ...
    icon: Network,
    capability: "credential.read_own",
  },
  {
    href: "/portfolio",
    label: "Portfolio",
  ...
  },
  {
    ...
    label: "Opportunities",
    icon: Briefcase,
    capability: "opportunity.apply_own",
  },
  {
    href: "/mentorship",
    label: "Mentorship",
    icon: Users,
    capability: "mentorship.request_own",
  },
  {
    href: "/outcomes",
    label: "Outcomes",
    icon: TrendingUp,
    capability: "outcomes.read_own",
  },
  {
    href: "/review",
    label: "Review queue",
  ...
  },
  {
    ...
    label: "Intelligence",
    icon: BarChart3,
    capability: "intelligence.read_org",
  },
];