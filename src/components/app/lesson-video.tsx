...
export function LessonVideo({ video, mapping }: { video: CurriculumVideo | null; mapping: LessonVideoMapping | null }) {
  ...
  return <section aria-label="Lesson video" className="space-y-3">
    ...
    <a href={video.source_url} target="_blank" rel="noopener noreferrer" className="inline-block rounded text-sm text-brand underline focus-visible:outline-2">Open Original Video</a>
