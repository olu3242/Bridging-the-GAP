...
files.set('supabase/migrations/20260920000600_curriculum_visual_seed.sql',
...
files.set('supabase/migrations/20260920000700_reference_cover_assets.sql','-- Replace unapproved diagram covers with true cover artwork. Preserve old versions.\n'+replacementCovers.map(a=>
